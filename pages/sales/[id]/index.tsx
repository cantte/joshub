      ...
      <main>
        <div className='w-full px-4'>
          <div className='bg-white p-8 py-12 rounded-lg shadow-xl'>
            <h1 className='text-gray-900 font-bold text-3xl'>Venta #{id}</h1>
            <p className='text-gray-600 mt-4 mb-8 leading-relaxed'></p>

            <SaleView id={id as string} />
          </div>
        </div>
      </main>
    </DefaultLayout>
...
export default withRequiredPub(SaleDetailPage)
