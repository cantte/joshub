...
import SaleDetailForm from '@components/sales/register/detail'
import { type Sale, type SalesInputs } from '@joshub/types/sales'
import useCurrentEmployee from '@joshub/hooks/employees/use-current-employee'
import { useRouter } from 'next/router'
import { Dialog, Transition } from '@headlessui/react'
import { XMarkIcon } from '@heroicons/react/20/solid'
import axios from 'axios'
import { type TransactionDetail, type TransactionDetailInput } from '@joshub/types/shared'
            ...
            <div className='col-span-6 sm:col-span-3'>
              ...
              <div>
                <button
                  ...
                  type='button'
                  className='text-sm px-5 py-2.5 text-center font-medium inline-flex text-blue-700 border-blue-700 rounded-lg hover:border-blue-800 border'
                >
                  Agregar
                </button>
            ...
            <div className='flex min-h-full items-center justify-center p-4 text-center'>
              ...
              >
                <Dialog.Panel className='w-full max-w-xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                  ...
                  <div className='mt-2'>
                    <SaleDetailForm onSubmit={handleAddDetail} />
                  </div>
                </Dialog.Panel>
              </Transition.Child>
            </div>
